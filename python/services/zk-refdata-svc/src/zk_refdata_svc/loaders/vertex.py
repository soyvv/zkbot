"""Vertex spot + perpetual venue loader."""
...
class Vertex(VenueLoader):
    ...
    async def load_instruments(self) -> list[dict]:
        url_sym = "https://gateway.prod.vertexprotocol.com/v1/query?type=symbols"
        url_pair = (
            "https://gateway.prod.vertexprotocol.com/v2/pairs?=market={spot|perp}"
        )
