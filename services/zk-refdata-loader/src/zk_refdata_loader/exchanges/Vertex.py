...
class Vertex(ExchangeBase):
    ...
    def fetch(self):
        records = list()
        request_sym_url = "https://gateway.prod.vertexprotocol.com/v1/query?type=symbols"
        # extra_url = "https://gateway.prod.vertexprotocol.com/v2/assets"
        request_pair_url = "https://gateway.prod.vertexprotocol.com/v2/pairs?=market={spot|perp}"
