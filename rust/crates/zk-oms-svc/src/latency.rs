...
//!
//! `t3 - t1` = oms_through: internal OMS processing time (queue wait + core).
...
impl LatencyTracker {
    ...
    #[inline]
    pub fn record_order_sent(&mut self, order_id: i64, order_created_at_ms: i64, t1_ns: i64, t3_ns: i64, t3r_ns: i64) {
